  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "cyber-gradient": "linear-gradient(135deg, hsl(var(--neon-cyan)) 0%, hsl(var(--neon-purple)) 100%)",
        "gold-gradient": "linear-gradient(135deg, hsl(var(--neon-gold)) 0%, hsl(28 96% 57%) 100%)",
      },
      boxShadow: {
